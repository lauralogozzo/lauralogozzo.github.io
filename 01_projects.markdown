...
To build a whole-ecosystem carbon budget for Frank Lake, we integrate techniques across the 
...
atmosphere, thus contributing to global carbon dioxide emissions. We measured 
...
anthropogenic perturbations to terrestrial carbon storage. This work was funded by the
...
We evaluated the concentrations and downstream fluxes of two size fractions of dissolved iron 
in relation to water temperature, river discharge, and DOM composition using long-term frequent 
monitoring on the Connecticut River mainstem. This approach allowed us to establish how the 
...
We quantified the contributions of dissolved ferric iron to UV-vis absorbance on commonly 
measured DOM UV-vis parameters for natural water samples collected from the Connecticut River 
watershed over 1.5 years. Further, we evaluated how ferric iron interference in UV-vis 
